...
export const TableHeader = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <thead ref={ref} className={cn("[&_tr]:border-b bg-slate-50 text-slate-700 font-semibold border-b border-slate-200", className)} {...props} />
  )
);
...
export const TableFooter = React.forwardRef<HTMLTableSectionElement, React.HTMLAttributes<HTMLTableSectionElement>>(
  ({ className, ...props }, ref) => (
    <tfoot ref={ref} className={cn("border-t bg-slate-50 font-medium text-slate-600 [&>tr]:last:border-b-0", className)} {...props} />
  )
);
...
export const TableHead = React.forwardRef<HTMLTableCellElement, React.ThHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <th
      ref={ref}
      className={cn(
        "h-9 px-3.5 text-left align-middle font-semibold text-slate-600 [&:has([role=checkbox])]:pr-0",
        className
      )}
      {...props}
    />
...
export const TableCell = React.forwardRef<HTMLTableCellElement, React.TdHTMLAttributes<HTMLTableCellElement>>(
  ({ className, ...props }, ref) => (
    <td ref={ref} className={cn("p-3.5 align-middle [&:has([role=checkbox])]:pr-0 text-slate-800", className)} {...props} />
  )
);
